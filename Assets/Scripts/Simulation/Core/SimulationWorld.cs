...
namespace DivineWorld.Simulation.Core
{
    ...
    /// Daily path: DailySimulation. Fast path: FastForwardSystem (no TickDay loop).
    /// </summary>
    public class SimulationWorld : MonoBehaviour
    {
        ...
        public string RunConsistencyTestOneYear()
        {
            ...
            var report = FastForwardConsistencyTest.Run(State, Races, Config, SimulationConfig.DaysPerYear);
