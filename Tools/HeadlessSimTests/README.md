...
| Arg | What it runs |
|-----|----------------|
| *(default)* | Phase2ATests + FertilityModifierDiagnostic + Phase2A2Tests + **P2-B v0.3 / v0.4 / v0.5** + **P2-C v0.2** |
...
| `p2c` / `p2c-v02` / `politics` | **P2-C v0.2** diplomatic actions, history, incidents, treaty placeholders, freeze |
